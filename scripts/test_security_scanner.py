...
from code_review_assistant.tools.security_scanner import SecurityScanner

async def test_dff_only():
    """Script to test the SecurityScanner with specific DFF data."""
    print("Starting SecurityScanner DFF test with specific data...")
    
    # Create SecurityScanner instance
    security_scanner = SecurityScanner()
    print("✅ SecurityScanner instance created")
    ...
    try:
        ...
        print("\nAnalyzing DFF data...")
        dff_result = await security_scanner.execute(dff_data=dff_data)
            ...
            for file_result in dff_result['results']:
                ...
                if 'issues' in file_result:
                    ...
                    for issue in file_result['issues']:
                        ...
                        if 'cwe_id' in issue and issue['cwe_id']:
                            print(f"   CWE ID: {issue.get('cwe_id', 'N/A')}")
